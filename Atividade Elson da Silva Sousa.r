# Carregar dados Animals como uma biblioteca em C 
data("Animals")
head(Animals)

# Explicação:
# Os dados "Animals" tem informações sobre o peso corporal (body)
...
calcular_moda <- function(vetor) {
  ...
  return(moda) #retorna o valor como em C numa TAD 
}
...
# Predição para um novo valor de 'body'
...
# Predição para um novo valor de 'body ' usando modelo não linear
